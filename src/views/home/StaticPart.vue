<template>
    ...
    南京工业职业技术大学南京工业职业技术大学南京工业职业技术大学
...
<div class="banner">
  <img src="https://pic-go.oss-cn-shanghai.aliyuncs.com/typora-img/202204251437622.jpeg" class="banner__img"/>
</div>
<div class="icons">
    <div class="icons__item" v-for="item in iconsList" :key="item.desc">
        <img class="icons__item__img" :src="`https://pic-go.oss-cn-shanghai.aliyuncs.com/jingdong/${item.imgName}.png`"/>
